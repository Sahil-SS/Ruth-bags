...
const categories = [
  ...
  },
  {
    id: 2,
    name: "Backpacks",
    img: "https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?q=80&w=600",
    bg: "#EAEAE8",
  },
  {
    id: 3,
  ...
  },
  {
    id: 8,
    name: "Travel",
    img: "https://images.unsplash.com/photo-1553531384-cc64ac80f931?q=80&w=600",
    bg: "#F9F6F1",
  },
];
...
const CategoryCircular = () => {
  return (
    <section className="mt-30 md:mt-20 py-8 md:py-20 px-4 bg-white">
                ...
                <div className="relative w-24 h-24 sm:w-28 sm:h-28 md:w-44 md:h-44 mb-6">
                  ...
                  <div className="relative z-10 w-full h-full rounded-full overflow-hidden border border-gray-100 shadow-sm group-hover:shadow-2xl transition-all duration-700">
                    <img
                      src={cat.img}
                      alt={cat.name}
                      className="w-full h-full object-cover mix-blend-multiply opacity-90 group-hover:opacity-100 transition-transform duration-500 group-hover:scale-110"
                    />
                  </div>
                </div>
