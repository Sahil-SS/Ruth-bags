...
const FEATURED_POSTS = [
  {
    ...
    excerpt:
      "Discover why we still use traditional saddle stitching for every leather piece...",
  ...
  },
  {
    ...
    excerpt:
      "Our journey to finding the most sustainable vegetable-tanned leathers...",
  ...
  },
  {
    ...
    excerpt:
      "How the philosophy of 'less is more' drives our seasonal design process...",
...
const BlogPreview = () => {
  return (
    <section className="bg-white py-5 md:py-25">
      <div className="max-w-360 mx-auto px-5 md:px-12">
        {/* Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16 gap-6">
          <div className="max-w-xl">
            <h2 className="text-5xl md:text-7xl font-serif italic lowercase tracking-tighter mb-4 md:mb-6">
              the journal.
            </h2>
          ...
          <Link
            href="/blog"
            className="group flex items-center gap-3 text-[10px] uppercase tracking-[0.4em] font-black border-b border-black pb-2 transition-all"
          >
            View All{" "}
            <ArrowRight
              size={14}
            ...
            {FEATURED_POSTS.map((post) => (
              ...
              >
                ...
                <div className="space-y-2 md:space-y-4">
                  <p className="text-[8px] md:text-[10px] text-gray-400 font-medium uppercase tracking-widest">
                    {post.date}
                  </p>
